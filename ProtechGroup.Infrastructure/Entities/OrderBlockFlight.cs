...
{
    [Table("OrderBlockFlight")]
    public class OrderBlockFlight
    {
        [Key]
        ...
        public int TickitBlockFlightId { get; set; }        
        [StringLength(250)]
        public string ItineraryDesc { get; set; }        
        public byte PaymentMethod { get; set; }        
        public byte TotalAdult { get; set; }        
        public byte TotalChild { get; set; }        
        public byte TotalInfant { get; set; }      
        ...
        public int TotalTickit { get; set; }
        [StringLength(500)]
